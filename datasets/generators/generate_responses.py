...
Usage:
    ...
    python generate_responses.py --manifest-file ../raw/images/manifest.json --output-file ../raw/sft_dataset.json --base-url http://localhost:8000/v1
...
Environment variables:
    ...
    VLM_MODEL_ID        - Model ID to use (default: gpt-4o)
...
DEFAULT_MODEL_ID = os.environ.get("VLM_MODEL_ID", "gpt-4o")
